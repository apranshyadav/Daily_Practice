    ...
    <>
      <nav className='dark:bg-gray-900 text-white flex justify-between items-center px-12 h-20'>
        ...
        <ul className='flex gap-8 text-lg'>
          <li className='flex items-center gap-2'><IoSearch size={24}/> Search</li>
          <li className='flex items-center gap-2'><BiSolidOffer size={24}/> Offers</li>
          <li className='flex items-center gap-2'><IoMdHelp size={24}/> Help</li>
          <li className='flex items-center gap-2'><CgProfile size={24}/> Sign In</li>
          <li className='flex items-center gap-2'><FaCartArrowDown size={24}/> Cart</li>
        </ul>
      </nav>
    </>
  )
